...
def countdown():
    global countdown_time, countdown_running
    if countdown_time > 0:
...
def open_linkedin(event):
    webbrowser.open("https://www.linkedin.com/in/ayushrawat220804/")

linkedin_label.bind("<Button-1>", open_linkedin)

# Open Instagram profile when clicked
def open_instagram(event):
    webbrowser.open("https://www.instagram.com/ayushrawat2208/")
